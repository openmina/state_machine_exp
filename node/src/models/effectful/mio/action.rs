...
pub enum MioOutputAction {
    PollCreate {
        uid: Uid,
        on_result: CompletionRoutine<(Uid, bool)>,
    },
    ...
    PollEvents {
        ...
        on_result: CompletionRoutine<(Uid, PollEventsResult)>,
    },
    EventsCreate {
        uid: Uid,
        capacity: usize,
    ...
    TcpWrite {
        ...
        data: Rc<[u8]>,
        on_result: CompletionRoutine<(Uid, TcpWriteResult)>,
    },
    TcpRead {
        ...
        on_result: CompletionRoutine<(Uid, TcpReadResult)>,
    },
    TcpGetPeerAddress {
        connection_uid: Uid,
        on_result: CompletionRoutine<(Uid, Result<String, String>)>,
    },
}
